        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 overflow-y-auto p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ url("/org/{$organization->org_slug}/warehouse/outward") }}"
                           class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('tenant.warehouse.outward') ? 'bg-amber-50 text-warehouse font-semibold' : 'text-gray-700 hover:bg-gray-100' }} transition-colors">
                            <span class="material-symbols-outlined text-lg w-5">output</span>
                            <span x-show="sidebarOpen" class="font-medium">Outward</span>
                        </a>
                    </li>
                </ul>
            </nav>
