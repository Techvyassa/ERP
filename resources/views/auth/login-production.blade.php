...
<head>
    ...
    <title>Production Login - Nexus ERP</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-slate-900 mb-2">Production Portal</h1>
        ...
        document.getElementById('loginForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok && data.success) {
                    ...
                    localStorage.setItem('login_portal_url', `/org/${orgSlug}/production/login`);
                    window.location.href = `/org/${orgSlug}/production/dashboard`;
                } else {
