    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="isOpen" 
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full sm:mx-0 sm:h-10 sm:w-10"
                         :class="{
                             ...
                             'bg-yellow-100 text-yellow-600': confirmColor === 'yellow',
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 whitespace-pre-line" x-text="message"></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t border-gray-100">
                <button type="button" 
                        @click="isOpen = false; if(onConfirm) onConfirm();"
                        ...
                        :class="{
                            ...
                            'bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-500': confirmColor === 'yellow',
