...
<head>
    ...
    <title>@yield('title', 'Organization') - {{ $organization->org_name }}</title>
            ...
            <div class="flex items-center justify-between p-4 border-b border-gray-200">
                <div class="flex items-center space-x-3" x-show="sidebarOpen">
                    ...
                    <div class="overflow-hidden">
                        <h2 class="text-sm font-semibold text-gray-900 truncate">Organization</h2>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ url($tenantType === 'subdomain' ? '/organization-dashboard' : "/org/{$organization->org_slug}/organization-dashboard") }}" 
                           class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('tenant.organization-dashboard') ? 'bg-purple-50 text-category' : 'text-gray-700 hover:bg-gray-100' }} transition-colors">
                            <span class="material-symbols-outlined text-lg w-5">dashboard</span>
                            <span x-show="sidebarOpen" class="font-medium">Organization Dashboard</span>
                        </a>
                    </li>
            ...
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-category">apartment</span>
                        <h1 class="text-xl font-semibold text-gray-900">@yield('page-title', 'Organization')</h1>
                    </div>
                </div>
                
                <div class="flex items-center space-x-4">
                    <span class="text-xs text-purple-600 px-3 py-1 bg-purple-50 rounded-full font-semibold">
