            ...
            <div class="mb-6 overflow-hidden rounded-xl border border-gray-200">
                <div class="flex items-center justify-between border-b border-gray-100 bg-gray-50 px-4 py-3">
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500">Inventory snapshot across all buckets for sales planning</p>
                    </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <template x-if="!fgStockLoading && fgStock.length === 0">
                                <tr>
                                    <td colspan="5" class="px-4 py-8 text-center text-gray-400">No finished goods stock found.</td>
                                </tr>
                            </template>
                            <template x-for="item in fgStock" :key="item.product_id">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3">
                                        ...
                                        <div class="text-[11px] font-semibold uppercase tracking-widest text-gray-400" x-text="item.product_code"></div>
                                    </td>
                                    <td class="px-4 py-3 text-right font-semibold text-emerald-700" x-text="formatQty(item.buckets?.AVAILABLE ?? 0)"></td>
                                    <td class="px-4 py-3 text-right font-semibold text-amber-600" x-text="formatQty(item.buckets?.QC_HOLD ?? 0)"></td>
                                    <td class="px-4 py-3 text-right font-semibold text-blue-600" x-text="formatQty(item.buckets?.RESERVED ?? 0)"></td>
                                    <td class="px-4 py-3 text-right font-bold text-gray-900" x-text="formatQty(item.total_on_hand) + ' ' + (item.uom_code || '')"></td>
                                </tr>
                            </template>
                        </tbody>
                    </table>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <template x-if="stockCheckOrders.length === 0">
                            <tr>
                                <td colspan="5" class="px-4 py-8 text-center text-gray-400">No orders pending stock check.</td>
                            </tr>
                        </template>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <template x-if="picklistOrders.length === 0">
                            <tr>
                                <td colspan="5" class="px-4 py-8 text-center text-gray-400">No orders ready for picklist generation.</td>
                            </tr>
                        </template>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <template x-if="pickingOrders.length === 0">
                            <tr>
                                <td colspan="5" class="px-4 py-8 text-center text-gray-400">No orders currently in picking stage.</td>
                            </tr>
                        </template>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <template x-if="dispatchOrders.length === 0">
                            <tr>
                                <td colspan="6" class="px-4 py-8 text-center text-gray-400">No orders pending dispatch.</td>
                            </tr>
                        </template>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <template x-if="dispatchedOrders.length === 0">
                            <tr>
                                <td colspan="6" class="px-4 py-8 text-center text-gray-400">No dispatched orders yet.</td>
                            </tr>
                        </template>
            ...
            <form @submit.prevent="submitSO()" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <template x-if="!manualCustomer">
                            <div>
                                ...
                                <p x-show="customers.length === 0" class="text-xs text-amber-600 mt-1">No customers found in master list.</p>
                            </div>
                        </template>
                        <!-- Manual entry -->
                        <template x-if="manualCustomer">
                ...
                <div class="border-t pt-4 border-gray-200 mt-4">
                    <div class="flex items-center justify-between mb-3">
                        <p class="text-sm font-medium text-gray-700">Products (<span x-text="form.line_items.length"></span>) <span class="text-red-500">*</span></p>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-3 py-3 align-top">
                                            ...
                                            <template x-if="selectedProduct(line.product_id)">
                                                <div class="mt-1.5 flex items-center justify-between text-[11px]">
                                                    <span class="text-gray-500" x-text="'Code: ' + (selectedProduct(line.product_id)?.product_code || 'NA')"></span>
                                                    <span :class="lineStockClass(line)"
                                                        class="font-semibold"
                                        ...
                                        <td class="px-3 py-3 align-top">
                                            ...
                                            <template x-if="line.product_id && line.qty">
                                                <p class="mt-1 whitespace-normal leading-tight text-[10px]" :class="lineStockClass(line)" x-text="lineQtyHint(line)"></p>
                                            </template>
                                        </td>
                                        <td class="px-3 py-3 align-top">
                                        ...
                                        <td class="px-3 py-3 align-top text-center">
                                            <button type="button" @click="removeLine(idx)" class="text-red-400 hover:text-red-600 mt-1 transition-colors" title="Remove line">
                    ...
                    <table class="w-full text-sm mb-6">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <template x-if="picklistLines.length === 0">
                                <tr>
                                    <td colspan="6" class="px-4 py-6 text-center text-gray-400">No line items found.</td>
                                </tr>
                            </template>
